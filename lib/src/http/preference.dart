...
class Preference<T extends Matcheable<T>> {
  ...
  static Parser<Preference> parser(final Parser<Matcheable> valueParser) {    
  ...
  Preference._internal(this.value, this.qualityFactor, this.parameters);

  int get hashCode => computeHashCode([value, qualityFactor, parameters]);

...
Future<Option<Multipart>> parseMultipartStream(
    ...
    Option<PartParser> partParserProvider(PartContentInfo contentInfo)) =>
        new MimeMultipartTransformer(boundary)
          ...
          .then((final List<Part> parts) =>
              new Option (new Multipart(boundary, parts)))
          .catchError((final MimeMultipartException e) => Option.NONE, test: (final e) => e is MimeMultipartException);
